set moduleName sigmoid_activation_L
...
set C_modelName {sigmoid_activation_L}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_V int 18 regular {array 10 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ result_V_address0 sc_out sc_lv 4 signal 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mlp_mul_mul_18s_1eOg_U478", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	input_V { ap_memory {  { input_V_address0 mem_address 1 4 }  { input_V_ce0 mem_ce 1 1 }  { input_V_q0 mem_dout 0 18 } } }
