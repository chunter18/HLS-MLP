...
#ifndef __mlp_mac_muladd_18bkb__HH__
#define __mlp_mac_muladd_18bkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(mlp_mac_muladd_18bkb) {
    ...
    SC_CTOR(mlp_mac_muladd_18bkb):  simcore_mac_0_U ("simcore_mac_0_U") {
