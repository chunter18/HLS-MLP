...
assign max_V_2_fu_101_p3 = ((tmp_16_fu_92_p2[0:0] === 1'b1) ? activated_L2_V_q0 : p_0_reg_42);

assign network_digit_1_fu_109_p3 = ((tmp_16_fu_92_p2[0:0] === 1'b1) ? network_digit_2_cast_fu_98_p1 : result_write_assign_reg_52);

assign network_digit_2_cast_fu_98_p1 = network_digit_reg_130;

assign network_digit_fu_81_p2 = (k_reg_64 + 4'd1);

assign tmp_16_fu_92_p2 = (($signed(activated_L2_V_q0) > $signed(p_0_reg_42)) ? 1'b1 : 1'b0);
