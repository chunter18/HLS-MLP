...
set C_modelArgList {
	...
	{ result_V int 18 regular {array 401 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ result_V_address0 sc_out sc_lv 9 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "result_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "result_V", "role": "address0" }} , 
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "1201", "Max" : "1201"}
]}
...
set Spec2ImplPortList { 
	...
	result_V { ap_memory {  { result_V_address0 mem_address 1 9 }  { result_V_ce0 mem_ce 1 1 }  { result_V_we0 mem_we 1 1 }  { result_V_d0 mem_din 1 18 } } }
}
