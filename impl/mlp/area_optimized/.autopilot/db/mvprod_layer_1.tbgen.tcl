...
set C_modelArgList {
	{ matrix_V int 18 regular {array 10025 { 1 3 } 1 1 }  }
	{ input_V int 18 regular {array 401 { 1 3 } 1 1 }  }
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "matrix_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "matrix_V", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mlp_mac_muladd_5nbkb_U3", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mlp_mac_muladd_18cud_U4", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10031", "Max" : "10032"}
...
set Spec2ImplPortList { 
	matrix_V { ap_memory {  { matrix_V_address0 mem_address 1 14 }  { matrix_V_ce0 mem_ce 1 1 }  { matrix_V_q0 mem_dout 0 18 } } }
