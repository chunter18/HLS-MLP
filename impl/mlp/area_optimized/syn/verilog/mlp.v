...
(* CORE_GENERATION_INFO="mlp,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7k325tffg676-2,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.286000,HLS_SYN_LAT=11860,HLS_SYN_TPT=10025,HLS_SYN_MEM=1,HLS_SYN_DSP=6,HLS_SYN_FF=1594,HLS_SYN_LUT=2087,HLS_VERSION=2018_2}" *)
...
output  [17:0] weights_L1_V_d0;
input  [17:0] weights_L1_V_q0;
output   weights_L1_V_we0;
output  [13:0] weights_L1_V_address1;
output   weights_L1_V_ce1;
output  [17:0] weights_L1_V_d1;
input  [17:0] weights_L1_V_q1;
output   weights_L1_V_we1;
...
wire   [17:0] bias_added_V_i_q0;
wire   [17:0] bias_added_V_t_q0;
...
wire   [8:0] add_bias_pre_L1_U0_input_V_address0;
wire    add_bias_pre_L1_U0_input_V_ce0;
wire   [8:0] add_bias_pre_L1_U0_result_V_address0;
wire    add_bias_pre_L1_U0_result_V_ce0;
wire    add_bias_pre_L1_U0_result_V_we0;
wire   [17:0] add_bias_pre_L1_U0_result_V_d0;
wire    ap_channel_done_bias_added_V;
wire    add_bias_pre_L1_U0_result_V_full_n;
...
wire   [13:0] mvprod_layer_1_U0_matrix_V_address0;
wire    mvprod_layer_1_U0_matrix_V_ce0;
wire   [8:0] mvprod_layer_1_U0_input_V_address0;
wire    mvprod_layer_1_U0_input_V_ce0;
...
wire   [31:0] tmp_p_src_mlp_cpp_lin_fu_117_ap_return;
wire    ap_sync_continue;
wire    bias_added_V_i_full_n;
wire    bias_added_V_t_empty_n;
...
assign add_bias_pre_L1_U0_ap_continue = bias_added_V_i_full_n;

assign add_bias_pre_L1_U0_ap_start = ((ap_sync_reg_add_bias_pre_L1_U0_ap_ready ^ 1'b1) & ap_start);

assign add_bias_pre_L1_U0_result_V_full_n = bias_added_V_i_full_n;
...
assign ap_channel_done_bias_added_V = add_bias_pre_L1_U0_ap_done;
...
assign input_V_address0 = add_bias_pre_L1_U0_input_V_address0;

assign input_V_address1 = 9'd0;

assign input_V_ce0 = add_bias_pre_L1_U0_input_V_ce0;

assign input_V_ce1 = 1'b0;

assign input_V_d0 = 18'd0;

assign input_V_d1 = 18'd0;
...
assign mvprod_layer_1_U0_ap_start = ((ap_sync_reg_mvprod_layer_1_U0_ap_ready ^ 1'b1) & bias_added_V_t_empty_n & ap_start);
...
assign tmp_p_src_mlp_cpp_lin_fu_117_ap_return = 32'd0;

assign weights_L1_V_address0 = mvprod_layer_1_U0_matrix_V_address0;

assign weights_L1_V_address1 = 14'd0;

assign weights_L1_V_ce0 = mvprod_layer_1_U0_matrix_V_ce0;

assign weights_L1_V_ce1 = 1'b0;

assign weights_L1_V_d0 = 18'd0;

assign weights_L1_V_d1 = 18'd0;

assign weights_L1_V_we0 = 1'b0;

assign weights_L1_V_we1 = 1'b0;

assign weights_L2_V_address0 = mvprod_layer_2_U0_matrix_V_address0;

assign weights_L2_V_address1 = 9'd0;

assign weights_L2_V_ce0 = mvprod_layer_2_U0_matrix_V_ce0;

assign weights_L2_V_ce1 = 1'b0;
