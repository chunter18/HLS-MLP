...
#ifndef _mlp_L2_bias_added_V_H_
#define _mlp_L2_bias_added_V_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "mlp_L2_bias_added_V_memcore.h"

SC_MODULE(mlp_L2_bias_added_V) {
    static const unsigned int DataWidth    = 18;
...
protected:
    ...
    mlp_L2_bias_added_V_memcore* mlp_L2_bias_added_V_memcore_U;
...
public:
    ~mlp_L2_bias_added_V();
    SC_CTOR(mlp_L2_bias_added_V) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        mlp_L2_bias_added_V_memcore_U = new mlp_L2_bias_added_V_memcore("mlp_L2_bias_added_V_memcore_U");
        mlp_L2_bias_added_V_memcore_U->clk      ( clk );
        mlp_L2_bias_added_V_memcore_U->reset    ( reset );
        mlp_L2_bias_added_V_memcore_U->ce0      ( i_ce0 );
        mlp_L2_bias_added_V_memcore_U->we0      ( i_we0 );
        mlp_L2_bias_added_V_memcore_U->address0 ( memcore_iaddr );
        mlp_L2_bias_added_V_memcore_U->d0       ( i_d0 );
        mlp_L2_bias_added_V_memcore_U->q0       ( i_q0 );

        mlp_L2_bias_added_V_memcore_U->ce1      ( t_ce0 );
        mlp_L2_bias_added_V_memcore_U->we1      ( t_we0 );
        mlp_L2_bias_added_V_memcore_U->address1 ( memcore_taddr );
        mlp_L2_bias_added_V_memcore_U->d1       ( t_d0 );
        mlp_L2_bias_added_V_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "mlp_L2_bias_added_V.trace");
            // ports
