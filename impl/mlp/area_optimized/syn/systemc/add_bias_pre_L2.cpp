...
add_bias_pre_L2::add_bias_pre_L2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_17_fu_82_p1);
    sensitive << ( i_reg_59 );
    ...
    sc_trace(mVcdFile, tmp_17_fu_82_p1, "tmp_17_fu_82_p1");
...
void add_bias_pre_L2::thread_input_V_address0() {
    input_V_address0 =  (sc_lv<5>) (tmp_17_fu_82_p1.read());
}
...
void add_bias_pre_L2::thread_tmp_17_fu_82_p1() {
    tmp_17_fu_82_p1 = esl_zext<64,5>(i_reg_59.read());
}
