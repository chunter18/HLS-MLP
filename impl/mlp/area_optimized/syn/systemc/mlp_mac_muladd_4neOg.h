...
#ifndef __mlp_mac_muladd_4neOg__HH__
#define __mlp_mac_muladd_4neOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(mlp_mac_muladd_4neOg) {
    ...
    SC_CTOR(mlp_mac_muladd_4neOg):  simcore_mac_2_U ("simcore_mac_2_U") {
