...
#ifndef __mlp_mul_mul_18s_1fYi__HH__
#define __mlp_mul_mul_18s_1fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mlp_mul_mul_18s_1fYi) {
    ...
    SC_CTOR(mlp_mul_mul_18s_1fYi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
