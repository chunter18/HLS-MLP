...
#ifndef __mlp_mul_mul_9ns_1cud__HH__
#define __mlp_mul_mul_9ns_1cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mlp_mul_mul_9ns_1cud) {
    ...
    SC_CTOR(mlp_mul_mul_9ns_1cud):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
