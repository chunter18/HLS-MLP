...
sigmoid_activation_L::sigmoid_activation_L(sc_module_name name) : sc_module(name), mVcdFile(0) {
    mlp_mul_mul_18s_1g8j_U60 = new mlp_mul_mul_18s_1g8j<1,3,18,18,33>("mlp_mul_mul_18s_1g8j_U60");
    mlp_mul_mul_18s_1g8j_U60->clk(ap_clk);
    mlp_mul_mul_18s_1g8j_U60->reset(ap_rst);
    mlp_mul_mul_18s_1g8j_U60->din0(grp_fu_215_p0);
    mlp_mul_mul_18s_1g8j_U60->din1(grp_fu_215_p1);
    mlp_mul_mul_18s_1g8j_U60->ce(ap_var_for_const0);
    mlp_mul_mul_18s_1g8j_U60->dout(grp_fu_215_p2);
...
sigmoid_activation_L::~sigmoid_activation_L() {
    ...
    delete mlp_mul_mul_18s_1g8j_U60;
}
