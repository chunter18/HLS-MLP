...
begin
    ...
    max_V_2_fu_101_p3 <= 
        activated_L2_V_q0 when (tmp_1_fu_92_p2(0) = '1') else 
        p_0_reg_42;
    network_digit_1_fu_109_p3 <= 
        network_digit_2_cast_fu_98_p1 when (tmp_1_fu_92_p2(0) = '1') else 
    ...
    tmp_1_fu_92_p2 <= "1" when (signed(activated_L2_V_q0) > signed(p_0_reg_42)) else "0";
